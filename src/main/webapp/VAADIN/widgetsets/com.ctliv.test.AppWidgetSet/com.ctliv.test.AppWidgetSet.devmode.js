...
var __gwtModuleFunction = $wnd.com_ctliv_test_AppWidgetSet;
var $sendStats = __gwtModuleFunction.__sendStats;
$sendStats('moduleStartup', 'moduleEvalStart');
var $gwt_version = "8.1.6";
var $strongName = '';
var $gwt = {};
...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.com.ctliv.test.AppWidgetSet=");
    idx += (13 + "com.ctliv.test.AppWidgetSet".length);  // 
  }
  if (idx >= 0) {
...
//# sourceURL=com.ctliv.test.AppWidgetSet-0.js
